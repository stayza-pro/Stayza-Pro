          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="group relative flex items-center gap-3 px-6 py-3 text-white rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 font-semibold"
                style={{ backgroundColor: brandColors.primary }}
              >
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex gap-2 pt-4 border-t border-gray-200">
                          <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-white rounded-lg transition-all text-sm"
                            style={{ backgroundColor: brandColors.primary }}
                          >
