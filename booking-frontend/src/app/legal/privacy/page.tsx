    ...
    <SectionPageShell>
      ...
      <div className="mx-auto max-w-6xl space-y-12 px-4 pb-16 pt-12 sm:px-6 lg:px-8">
        ...
        <section className="rounded-3xl border border-dashed border-marketing-subtle/70 bg-white/95 p-8 text-sm text-marketing-muted shadow-[0_20px_70px_rgba(15,23,42,0.12)]">
          <p>
            Need a signed agreement or custom terms? We provide a data
            processing addendum with every enterprise plan and can collaborate
            with your counsel on bespoke requirements.
          </p>
