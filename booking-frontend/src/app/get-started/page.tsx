...
export default function GetStartedPage() {
  ...
  return (
    <MarketingPageLayout
      ...
      heroSlot={
        <div className="inline-flex flex-wrap items-center gap-3 text-sm text-white/80">
          <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1 uppercase tracking-[0.28em]">
            Instant setup
          </span>
          <span className="rounded-full border border-white/20 bg-white/10 px-3 py-1 uppercase tracking-[0.28em]">
            Automated payouts
          ...
          <CTAButton
            ...
            variant="outline"
            href="/early-access"
            className="bg-white text-[var(--marketing-primary)] hover:bg-white/90"
          />
        </div>
      }
    >
        ...
        <div className="space-y-8">
          <div className="rounded-3xl border border-marketing-subtle/60 bg-gradient-to-br from-white to-[rgba(243,244,246,0.85)] p-8 shadow-[0_24px_70px_rgba(15,23,42,0.14)]">
            ...
            <p className="mt-3 text-sm text-marketing-muted">
              Select the plan that mirrors your team&rsquo;s stage. We route you
              to a tailored signup that pre-loads the right onboarding
              checklist.
            </p>
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-[rgba(255,255,255,0.3)] bg-gradient-to-br from-[rgba(17,24,39,0.92)] to-[rgba(30,64,175,0.9)] p-8 text-white shadow-[0_28px_90px_rgba(15,23,42,0.45)]">
            ...
            <p className="mt-3 text-sm text-white/75">
              We route you to a plan-specific signup flow. Once you confirm your
              agency details, we spin up your microsite, connect payouts, and
              guide you through your first property in under 15 minutes.
            </p>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              ...
              <button
                ...
                disabled={isPending}
                className="rounded-xl border border-white/30 px-5 py-2 text-sm font-semibold text-white transition hover:border-white/60 hover:bg-white/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
              >
                {isPending
                  ? "Launching flow..."
          ...
          <div className="rounded-3xl border border-marketing-subtle/70 bg-white/95 p-8 shadow-[0_18px_70px_rgba(15,23,42,0.12)]">
            ...
            <p className="mt-4 text-xs text-marketing-muted">
              We respond to onboarding questions within one business day and can
              have your microsite production-ready in under a week.
            </p>
          </div>
        </div>
      </section>
