        ...
        >
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Access your realtor dashboard and manage your properties
            </p>
          </div>
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    {...register("email")}
                    type="email"
                    className={`block w-full pl-10 pr-3 py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 ${
              ...
              <div>
                ...
                <div className="mt-1 relative">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-10 py-2 border rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 ${
