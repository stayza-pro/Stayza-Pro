...
export const metadata = {
  ...
  description:
    "Be among the first realtors to launch your branded booking platform. Join 100+ property managers on the waitlist. No subscription fees, only 10% commission on bookings.",
  openGraph: {
    title: "Join the Waitlist - Get Early Access to Stayza Pro",
    description:
